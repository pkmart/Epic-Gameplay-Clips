...
<body>
   ...
   <nav class="navbar navbar-expand-lg  fixed-top" style="background-color:black">
    ...
    <center style="width: 40%; margin: 20px 0px 20px 20px"><h1 style="padding:20px 0px;"> Contact Us</h1>
        <form action="../php/contact_processor.php"  method="post" id="contactform">
            <label for="InputName" class="control-label">Name</label>
            <input type="text" name="vname" class="form-control" placeholder="Your Name">
            <br>
            <label for="InputName" class="control-label">Email (requiered)</label>
            <input type="text" name="vemail" class="form-control" placeholder="Your Email" required="true">
            <br>
            <label for="InputName" class="control-label">Subject</label>
             <input type="text" name="msub" class="form-control" placeholder="Subject">
            <br>
            <label for="InputName" class="control-label">Message (requiered)</label>
            <textarea class="form-control" rows="5" placeholder="Your Message" name="msg" form="contactform" required="true"> </textarea>
            <br>
            <input type="submit" name="" class="btn btn-primary btn-lg btn-block login-button" value="Send">
        </form>
    </center>
